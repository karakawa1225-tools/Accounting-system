...
CREATE INDEX IF NOT EXISTS bizgo_expense_account_idx ON bizgo_expense_lines (account_id);
CREATE INDEX IF NOT EXISTS bizgo_expense_category_idx ON bizgo_expense_lines (category_label);
CREATE INDEX IF NOT EXISTS bizgo_expense_tax_cat_idx ON bizgo_expense_lines (tax_category);
...
CREATE INDEX IF NOT EXISTS bizgo_trip_account_idx ON bizgo_trip_expense_lines (account_id);
CREATE INDEX IF NOT EXISTS bizgo_trip_category_idx ON bizgo_trip_expense_lines (category_label);
CREATE INDEX IF NOT EXISTS bizgo_trip_tax_cat_idx ON bizgo_trip_expense_lines (tax_category);
`);

console.log("bizgo expense tables OK");
